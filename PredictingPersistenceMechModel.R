...
##########################################
#Try this without a mixed effects model - drop random effects
OFFSET=TRUE
if (OFFSET==TRUE)
{
  Model1111 = glm(infected ~ 0 + best.y + best.p + median.ct + rel.susc, offset=LogitMechPassage, family="binomial", data=Data25)
  Model1110 = glm(infected ~ 0 + best.y + best.p + median.ct, offset=LogitMechPassage, family="binomial", data=Data25)
  
  Model1101 = glm(infected ~ 0 + best.y + best.p +             rel.susc , offset=LogitMechPassage, family="binomial", data=Data25)
  Model1100 = glm(infected ~ 0 + best.y + best.p                        , offset=LogitMechPassage, family="binomial", data=Data25)
  
  Model1011 = glm(infected ~ 0 + best.y +          median.ct + rel.susc , offset=LogitMechPassage , family="binomial", data=Data25)
  Model1010 = glm(infected ~ 0 + best.y +          median.ct        , offset=LogitMechPassage, family="binomial", data=Data25)
  
  Model0111 = glm(infected ~ 0 +          best.p + median.ct + rel.susc , offset=LogitMechPassage , family="binomial", data=Data25)
  Model0110 = glm(infected ~ 0 +          best.p + median.ct , offset=LogitMechPassage , family="binomial", data=Data25)
  
  Model1001 = glm(infected ~ 0 + best.y +                      rel.susc , offset=LogitMechPassage , family="binomial", data=Data25)
  Model1000 = glm(infected ~ 0 + best.y                              , offset=LogitMechPassage , family="binomial", data=Data25)
  
  Model0101 = glm(infected ~ 0 +          best.p +             rel.susc , offset=LogitMechPassage , family="binomial", data=Data25)
  Model0100 = glm(infected ~ 0 +          best.p                         , offset=LogitMechPassage , family="binomial", data=Data25)
  
  Model0011 = glm(infected ~ 0 +                   median.ct + rel.susc , offset=LogitMechPassage , family="binomial", data=Data25)
  Model0010 = glm(infected ~ 0 +                   median.ct      , offset=LogitMechPassage , family="binomial", data=Data25)
  
  Model0001 = glm(infected ~ 0 +                               rel.susc , offset=LogitMechPassage , family="binomial", data=Data25)
  Model0000 = glm(infected ~ 0                                        , offset=LogitMechPassage , family="binomial", data=Data25)
